...
//
// Валидация входящих данных (title, status) — в API слое на DTO. При заданном AssigneeID — GetMember(teamID, assigneeID), при ErrMemberNotFound → model.ErrAssigneeNotInTeam.
type TaskService interface {
	// Create создаёт задачу. userID — участник команды; teamID в сигнатуре. AssigneeID — должен быть в команде.
